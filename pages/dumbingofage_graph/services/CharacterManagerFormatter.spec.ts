...
describe("formatter", () => {
  it("must reduce the edge and node content by a give minimal value", () => {
    const nodes = [{
      "id":1,"label":"becky", "image": "/avatar/becky.png"},
      {"id":2,"label":"joyce"},{"id":3,"label":"hank"},{"id":4,"label":"asma"},
      {"id":5,"label":"jennifer", "image": "/avatar/jennifer.png"}
    ];
    ...
    const expectedNodes: Array<Nodes> = [
      { id: 1, label: '', "fixed": { "x": true, "y": true }, physics: false, "image": "/avatar/becky.png" },     
      { id: 2, label: 'joyce', "fixed": { "x": true, "y": true }, physics: false },     
      { id: 4, label: 'asma', "fixed": { "x": true, "y": true }, physics: false },      
      { id: 5, label: '', "fixed": { "x": true, "y": true }, physics: false, "image": "/avatar/jennifer.png" }
    ];
